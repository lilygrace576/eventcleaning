...
// std::string dataDir = "/ospool/uw-shared/projects/GATech_Otte/TrinityDemonstrator/DataAnalysis/MergedData/Output/";
// std::string outDir = "/home/projects/GATech_Otte/TrinityDemonstrator/DataAnalysis/flasher_calibration/Output/";
